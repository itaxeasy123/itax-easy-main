      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 justify-center sm:justify-start items-end">
          ...
          <div className="text-sm font-normal text-gray-600">Old Regime</div>
            ...
            <div
              className={`${classes} ${classes2} w-full rounded-md border border-primary_light p-4 sm:p-8 md:w-[950px] [&>div]:border-b [&>div]:border-b-primary_light [&_div]:flex [&_div]:items-center [&_div]:justify-between [&_div]:gap-2 [&_div]:py-1`}
              id="advancetaxdiv"
            >
