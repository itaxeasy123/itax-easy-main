  ...
  return (
    <>
      <div className="bt-green-50 text-justify  rounded-4xl text-2xl container mx-auto ">
        <div className="header text-center text-3xl md:text-5xl font-semibold  pt-28 ">
          About Us
        </div>
      ...
      <div className="container mx-auto mt-10 ">
        <div className="grid md:grid-cols-2 sm:grid-cols-1 ">
          ...
          <div>
            <div className="px-8  space-y-6 pt-8 md:pt-36">
      ...
      <div>
        <div>
          <div className="header text-center font-semibold text-3xl md:text-5xl  pt-28 ">
            Our Mission
          </div>
          <div className="header2 text-center text-xl  pt-3 ">
          ...
          <div className=" relative container mx-auto shadow-lg rounded-xl grid my-20 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
            <div className="absolute -bottom-0 left-4 md:left-72 ml-0 md:ml-24 rounded-full bg-white  px-6 md:px-40 py-10 ">
              Our Vision is to make The World Powerful{' '}
            </div>
            <div className="mission px-6 py-12 md:px-20 md:py-44 text-justify ">
        ...
        <div>
          <div className=" our vision header text-center text-3xl md:text-5xl font-semibold pt-28 ">
            Our Vision
          </div>
          ...
          <div className=" relative container mx-auto shadow-lg rounded-xl grid my-20 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
            ...
            <div className="vision p-6 md:p-20 text-justify">
              A mission statement is typically longer and more detailed than a
              vision statement and should be specific, measurable and most
              importantly actionable.For example, a finance company&apos;s
              mission statement may be to &quot;provide accessible and
