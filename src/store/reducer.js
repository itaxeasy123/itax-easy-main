...
export default function reducer(state, { type, payload }) {
	...
	switch (type) {
		...
		case FORM_16_IMPORT:
			console.log("🔥 REDUCER HIT: FORM_16_IMPORT", payload);
			...
			return {
				...
				itr: {
					...
					// ✅ Merge deductions from Form16 into main deductions state
					deductions: {
						...
						section80Deductions: {
							...
							totalDeduction:
								payload?.deductionsUnderChapterVIA?.section80C?.deductibleAmount || 0
						}
					}
				}
			};
